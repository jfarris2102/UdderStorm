...
function displayHUDtext(){
   ...
   // if(doomsDay-getYears() < 1) 
    ...
    days = getDays()%31;
    timeD = "DATE:  "+ getYears() + "."+ getMonths()+"."+ days;
    moneyD="MONEY:  "+moneyRound+"mil";
    researchD="RESEARCH:  "+research;
    diplomacyD="DIPLOMACY:  "+diplomacy;
    economyD="ECONOMY:  "+economy;
    popEarthD="POPULATION:  "+popRound+"bil";
    popMarsD="POPULATION:  "+popMars;
    energyD="ENERGY:  "+energyRound+"mil BTU";
    mineralsD="MINERALS:  "+minerals;
    airD=pad+air+"%";
    foodD="FOOD:  "+food;
    waterD="WATER:  "+water;
    pad = "";
    ...
    atmosphereD= pad+atmosphere+" kPa";
    temperatureD=temperature+" F";
    happinessD="HAPPINESS:  "+happiness+"%";
